...
export const DEV_CONFIG = {
  ...
  NETWORK: {
    ...
    rpcUrl: getEnvConfig('VITE_RPC_URL', 'https://sepolia.infura.io/v3/s9YBJHw1dEizTkvbyMkn0')
  },
  // KYC配置
  KYC: {
...
export const PROD_CONFIG = {
    KYC_REGISTRY_ADDRESS: getEnvConfig('VITE_KYC_REGISTRY_ADDRESS_PROD', '0x0A96077ffe3f06274d869ba1eed6cB7324270C2f'),
    LOAN_ISSUER_ADDRESS: getEnvConfig('VITE_LOAN_ISSUER_ADDRESS_PROD', '0x13159e6417D98528C220b12Ec4950D5A343E5eAA'),
    PRINCIPAL_TOKEN_ADDRESS: getEnvConfig('VITE_PRINCIPAL_TOKEN_ADDRESS_PROD', '0xA41b4F0417d588a08F914Ca17b07c99783D5c3FC'),
    INTEREST_TOKEN_ADDRESS: getEnvConfig('VITE_INTEREST_TOKEN_ADDRESS_PROD', '0x9d3175E3F8c055389e070e058f717D450bB89206'),
    TRADE_CONTRACT_ADDRESS: getEnvConfig('VITE_TRADE_CONTRACT_ADDRESS_PROD', '0x13159e6417D98528C220b12Ec4950D5A343E5eAA'),
    COMPLIANCE_GUARD_ADDRESS: getEnvConfig('VITE_COMPLIANCE_GUARD_ADDRESS_PROD', '0x448d5FB04025FDb01b97e9bB5e5FD12c687cd480'),
    HOLDER_REGISTRY_ADDRESS: getEnvConfig('VITE_HOLDER_REGISTRY_ADDRESS', '0x1E77C41899D1d34A11E3BF55809962fE6a929074'),
  NETWORK: {
    chainId: parseInt(getEnvConfig('VITE_NETWORK_CHAIN_ID_PROD', '1')),
    name: getEnvConfig('VITE_NETWORK_NAME_PROD', 'Ethereum Mainnet'),
    rpcUrl: getEnvConfig('VITE_RPC_URL_PROD', 'https://mainnet.infura.io/v3/s9YBJHw1dEizTkvbyMkn0')
  },
  // KYC配置
  KYC: {
