...
export const DEV_CONFIG = {
  ...
  NETWORK: {
    ...
    rpcUrl: getEnvConfig('VITE_RPC_URL', 'https://sepolia.infura.io/v3/YOUR_INFURA_PROJECT_ID')
  },
  // KYC配置
  KYC: {
...
export const PROD_CONFIG = {
    KYC_REGISTRY_ADDRESS: getEnvConfig('VITE_KYC_REGISTRY_ADDRESS_PROD', '0x4533f47BE0ce8b80F7bbdF02939f81F4A15b7A45'),
    LOAN_ISSUER_ADDRESS: getEnvConfig('VITE_LOAN_ISSUER_ADDRESS_PROD', '0x1234567890123456789012345678901234567890'),
    PRINCIPAL_TOKEN_ADDRESS: getEnvConfig('VITE_PRINCIPAL_TOKEN_ADDRESS_PROD', '0x45b1eCb3D9af651244eC656ed15B86404924c354'),
    INTEREST_TOKEN_ADDRESS: getEnvConfig('VITE_INTEREST_TOKEN_ADDRESS_PROD', '0xE6aeE4a898c6d99033ee5380Df407C5DD470fb17'),
    TRADE_CONTRACT_ADDRESS: getEnvConfig('VITE_TRADE_CONTRACT_ADDRESS_PROD', '0x1234567890123456789012345678901234567890'),
    COMPLIANCE_GUARD_ADDRESS: getEnvConfig('VITE_COMPLIANCE_GUARD_ADDRESS_PROD', '0x1234567890123456789012345678901234567890'),
  NETWORK: {
    chainId: parseInt(getEnvConfig('VITE_NETWORK_CHAIN_ID_PROD', '1')),
    name: getEnvConfig('VITE_NETWORK_NAME_PROD', 'Ethereum Mainnet'),
    rpcUrl: getEnvConfig('VITE_RPC_URL_PROD', 'https://mainnet.infura.io/v3/YOUR_INFURA_PROJECT_ID')
  },
  // KYC配置
  KYC: {
